                ...
                <form method="POST" action="{{ route('employee.update',$employee->id) }}">
                  ...
                  <div class="card-body">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control @error('inputEmployeeFirstName') is-invalid @enderror" name="inputEmployeeFirstName" id="inputEmployeeFirstName" placeholder="Enter first name" value="{{ $employee->first_name }}">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control @error('inputEmployeeLastName') is-invalid @enderror" name="inputEmployeeLastName" id="inputEmployeeLastName" placeholder="Enter last name" value="{{ $employee->last_name }}">
                    ...
                    <div class="form-group">
                      ...
                      <input type="email" class="form-control @error('inputEmployeeEmail1') is-invalid @enderror" name="inputEmployeeEmail1" id="inputEmployeeEmail1" placeholder="Enter email" value="{{ $employee->email }}">
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control @error('inputEmployeePhone') is-invalid @enderror" name="inputEmployeePhone" id="inputEmployeePhone" placeholder="Enter phone number" value="{{ $employee->phone }}">
